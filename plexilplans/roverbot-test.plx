...
<PlexilPlan xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
   ...
   <Node NodeType="NodeList" epx="Sequence" LineNo="21" ColNo="1">
      ...
      <NodeBody>
         <NodeList>
            <Node NodeType="Command" LineNo="22" ColNo="1">
               ...
               <NodeBody>
                  <Command>
                     ...
                     <Arguments LineNo="23" ColNo="8">
                        <StringValue>hello</StringValue>
                     </Arguments>
                  </Command>
               </NodeBody>
            </Node>
            <Node NodeType="Command" LineNo="23" ColNo="3">
            ...
            <Node NodeType="Command" LineNo="24" ColNo="1">
