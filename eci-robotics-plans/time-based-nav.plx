                           ...
                           <NOT>
                              <OR>
                                 ...
                                 <AND>
                                    <EQInternal>
                                       <NodeOutcomeVariable>
                                          <NodeRef dir="child">Delay1</NodeRef>
                                       </NodeOutcomeVariable>
                                       <NodeOutcomeValue>FAILURE</NodeOutcomeValue>
                                    </EQInternal>
                                    <EQInternal>
                                 ...
                                 <AND>
                                    <EQInternal>
                                       <NodeOutcomeVariable>
                                          <NodeRef dir="child">Delay2</NodeRef>
                                       </NodeOutcomeVariable>
                                       <NodeOutcomeValue>FAILURE</NodeOutcomeValue>
                                    </EQInternal>
                                    <EQInternal>
                           ...
                           <NodeList>
                              ...
                              <Node NodeType="Command" LineNo="27" ColNo="12">
                                 ...
                                 <StartCondition>
                                    <EQInternal>
                                       <NodeStateVariable>
                                          <NodeRef dir="sibling">Delay1</NodeRef>
                                       </NodeStateVariable>
                                       <NodeStateValue>FINISHED</NodeStateValue>
                                    </EQInternal>
                                 </StartCondition>
                              ...
                              <Node NodeType="NodeList" epx="Sequence" LineNo="32" ColNo="16">
                                 ...
                                 <NodeBody>
                                    <NodeList>
                                       <Node NodeType="Empty" epx="Wait" LineNo="32" ColNo="16">
                              ...
                              <Node NodeType="Command" LineNo="33" ColNo="12">
                                 ...
                                 <StartCondition>
                                    <EQInternal>
                                       <NodeStateVariable>
                                          <NodeRef dir="sibling">Delay2</NodeRef>
                                       </NodeStateVariable>
                                       <NodeStateValue>FINISHED</NodeStateValue>
                                    </EQInternal>
                                 </StartCondition>
                                 <NodeBody>
                                    <Command>
                                       ...
                                       <Arguments LineNo="34" ColNo="20">
                                          <StringValue>Done waiting 2.</StringValue>
                                       </Arguments>
                                    </Command>
                                 </NodeBody>
                              </Node>
